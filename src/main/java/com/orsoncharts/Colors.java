...
//    // automn colors
//    public static Color[] getTestPalette2() {
//        Color[] result = new Color[8];
//        result[0] = new Color(221,144,63);
//result[1] = new Color(141,220,98);
//result[2] = new Color(68,68,32);
//result[3] = new Color(198,190,131);
//result[4] = new Color(207,201,65);
//result[5] = new Color(103,144,65);
//result[6] = new Color(142,93,52);
//result[7] = new Color(151,131,51);
//        return result;
//    }
    
//    public static Color[] getTestPalette3() {
//        Color[] result = new Color[10];
//        result[0] = new Color(32,96,62);
//        result[1] = new Color(119,78,22);
//        result[2] = new Color(55,55,31);
//        result[3] = new Color(70,80,24);
//        result[4] = new Color(107,85,51);
//        result[5] = new Color(79,48,15);
//        result[6] = new Color(60,100,36);
//        result[7] = new Color(70,92,65);
//        result[8] = new Color(33,60,41);
//        result[9] = new Color(62,55,13);
//        return result;
//    }
