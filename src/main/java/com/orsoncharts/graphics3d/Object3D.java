...
public class Object3D {
   ...
   * @return 
   */
  public static Object3D createZSheet(double dim, double xOffset, double yOffset,
   ...
   * @return The object.
   */
  public static Object3D createCube(double size, double xOffset, double yOffset,
      double zOffset, Color color) {
  ...
  public static Object3D createPieSegment(double radius, double explodeRadius, 
          double base, double height, double angle1, double angle2, double inc,
          Color color) {
    Object3D segment = new Object3D();
    double angleCentre = (angle1 + angle2) / 2.0;
    Point3D centre = new Point3D(explodeRadius * Math.cos(angleCentre), base, 
            explodeRadius * Math.sin(angleCentre));
    float cx = centre.x;
    float cz = centre.z;
